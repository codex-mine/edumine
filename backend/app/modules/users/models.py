...
class Staff(Base, UUIDPrimaryKeyMixin, TimestampMixin, SoftDeleteMixin):
    """Non-teaching employees (accountant, receptionist, general staff)."""
...
class StaffQualification(Base, UUIDPrimaryKeyMixin, TimestampMixin):
