...
export default function AccountantInvoiceDetailPage() {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <Button variant="ghost" size="sm" className="w-fit print:hidden" onClick={() => router.push("/accountant/billing/invoices")}>
