...
export default function GuardianInvoiceDetailPage() {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <Button variant="ghost" size="sm" className="w-fit print:hidden" onClick={() => router.push("/guardian/billing")}>
        <ArrowLeft className="size-4" aria-hidden="true" />
        Back to children&apos;s billing
      </Button>
